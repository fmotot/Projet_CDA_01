		...
		<div class="row">
			...
			<div class="content-vente col-12 col-lg-7">
				...
				<form action="./NouvelleVenteServlet" method="post">
					...
					<div class="form-group row">
    					<label for="selectCategories" class="col-5 col-form-label-sm">Cat�gories :</label>
    					<div class="col-7 col-lg-7">
...
<!-- 						<input id="my-file-selector" type="submit" class="d-none" disabled>Uploader </label> --> 
					...
					<div class="form-group row">
						...
						<div class="col-7 col-lg-7">
							<input value="${!empty vente.miseAPrix ? vente.miseAPrix : '' }" name="inputPrixDeBase" type="number" class="form-control form-control-sm" id="inputPrixDeBase" placeholder="Mise � prix" required>
						</div>
					</div>
					<div class="form-group row">
						<label for="inputFinEnchere" class="col-5 col-form-label-sm">Fin de l'ench�re :</label>
						<div class="col-7 col-lg-7">
