		...
		<form action="./ListeEnchereServlet" method="post">
			...
			<div class="col-12 col-lg-8 d-none d-lg-block mx-auto my-auto">
				<div class="input-group row col-10 col-lg-8 mb-3">
					...
					<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Le nom de l'article contient">
				</div>

				<div class="form-group row col-12 col-lg-8">
					<label class="col-4 col-lg-3 my-auto" for="inputCategories">Catégories :</label>
					<select id="inputCategories" class="form-control col-8 col-lg-9">
			...
			<div class="col-12 col-lg-6 d-lg-none">
				<div class="form-group mt-3 row col-12 col-lg-6">
					...
					<select id="inputCategories" class="form-control col-8 my-auto">
						<option selected>Toutes</option>
					</select>
				</div>
